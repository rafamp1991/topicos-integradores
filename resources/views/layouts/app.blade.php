      ...
      <div class="main_container">
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            <div class="navbar nav_title" style="border: 0;">
              <a href="/" class="site_title"><i class="fa fa-home"></i> <span>Home</span></a>
            </div>
                ...
                <ul class="nav side-menu">
                  <li><a ><i class="fa fa-users"></i> Clientes <span class="fa fa-chevron-down"></span></a>
                      <ul class="nav child_menu">
                       ...
                       <li><a href="/listClient">Listar</a></li>
                    </ul>
                  </li>

                  <li><a ><i class="fa fa-car"></i> Veiculos <span class="fa fa-chevron-down"></span></a>
                      <ul class="nav child_menu">
                       <li><a href="/veiculos/create">Cadastrar</a></li>
                       <li><a href="/listVehicle">Listar</a></li>
                    </ul>
                  </li>
        ...
        <footer>
          <div class="pull-right">
            Desenvolvido por Rafael Martins de Padua
          </div>
          <div class="clearfix"></div>
        </footer>
        <!-- /footer content -->
